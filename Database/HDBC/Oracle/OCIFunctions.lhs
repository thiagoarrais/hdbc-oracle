...
|
Module      :  Database.Oracle.OCIFunctions (renamed to Database.HDBC.Oracle.OCIFunctions upon inclusion into HDBC Oracle driver)
...
> module Database.HDBC.Oracle.OCIFunctions where
