...
|
Module      :  Database.Oracle.OCIConstants (renamed to Database.HDBC.Oracle.OCIConstants upon inclusion into HDBC Oracle driver)
...
> module Database.HDBC.Oracle.OCIConstants where
